...
export VANI_ENDPOINT_MIN_DELAY="${VANI_ENDPOINT_MIN_DELAY:-0.05}"
export VANI_ENDPOINT_MAX_DELAY="${VANI_ENDPOINT_MAX_DELAY:-0.15}"
export VANI_INTERRUPT_MIN_DURATION="${VANI_INTERRUPT_MIN_DURATION:-0.08}"
